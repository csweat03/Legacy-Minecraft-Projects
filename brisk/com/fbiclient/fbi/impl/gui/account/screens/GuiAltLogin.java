...
public class GuiAltLogin extends GuiScreen {
        ...
        switch (button.id) {
            ...
            case 0:
                if (combined.getText().isEmpty())
                    thread = new Authentication(username.getText(), password.getText());
                    ...
                    thread = new Authentication(u.replaceAll(" ", ""), p.replaceAll(" ", ""));
                } else
                    thread = new Authentication(username.getText(), password.getText());
                thread.start();
        }
    ...
    public void initGui() {
        ...
        password = new PasswordField(0, mc.fontRendererObj, width / 2 - 100, 90, 200, 20);
