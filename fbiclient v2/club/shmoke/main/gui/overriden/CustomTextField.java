package club.shmoke.main.gui.overriden;
...
public class CustomTextField extends Gui {
    ...
    private FontUtility.CFontRenderer font;
    ...
    public CustomTextField(int componentId, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
        this.font = Client.GET.FONT_UTILITY.def;
        this.xPosition = x;
        this.yPosition = y;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                new Utility().renderUtility.drawBorderRect(this.xPosition + 1, this.yPosition, this.xPosition + this.width - 1, this.yPosition + this.height - 1, -6250336, 0x00ffffff);
            }
            ...
            if (s.length() > 0) {
                ...
                j1 = (int) font.drawStringWithShadow(s1, (float) l, (float) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int) this.font.drawStringWithShadow(s.substring(j), (float) j1, (float) i1, i);
            }
    ...
    /**
     * Sets focus to this customizable_gui element
     */
