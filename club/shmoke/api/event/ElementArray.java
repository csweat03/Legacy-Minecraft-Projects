...
public class ElementArray<T> implements Iterable<T>
{
    ...
    public ElementArray(final T[] array)
    {
        this.elements = array;
    }
    ...
    public Iterator<T> iterator()
    {
        return new Iterator<T>()
        {
            ...
            {
                return this.index < ElementArray.this.size() && ElementArray.this.get(this.index) != null;
            }
            @Override
            public T next()
            {
                return ElementArray.this.get(this.index++);
            }
            @Override
            public void remove()
            {
                ElementArray.this.remove(ElementArray.this.get(this.index));
            }
        };
    }
}
